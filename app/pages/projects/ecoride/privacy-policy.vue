...
definePageMeta({
  ...
  ecorideTitle: 'Privacy Policy'
})

useHead({
  title: 'Ecoride Privacy Policy',
  meta: [
...
const { data: rawMarkdown } = await useAsyncData('ecoride-privacy-policy-md', () =>
  $fetch<string>('/api/ecoride/privacy-policy', { responseType: 'text' })
)
